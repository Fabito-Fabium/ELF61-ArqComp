...
PORT (   
        ...
        -- sinais que sao a interface de teste no HW fisico
		  ...
		  SWITCH_HW : in unsigned (9 downto 8);   --SW9 e SW8  (PINS F15, B14)
...
ARCHITECTURE LogicFunction OF toplevel IS
	...
	SIGNAL PC_add_out: unsigned(15 downto 0);  -- address
	SIGNAL PC_data_out: unsigned(15 downto 0); -- data
...
BEGIN
	...
	PORT MAP(
				clk 	  => clk_div_s,
				rst 	  => rst_proc,
				instruction_content 	  => PC_data_out,
				address_o 					=> PC_add_out			
	);
   ...
   -- Sinais ligados ao RAMDisp
	...
	wr_enRAMDisp <= '1';
	dado_inRAMDisp <= PC_data_out;
	dado_adRAMDisp <= PC_add_out;
